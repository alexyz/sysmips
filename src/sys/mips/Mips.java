...
public final class Mips {
	...
	public static final String[][] CP_REG_NAMES = new String[][] { new String[] { "Index", "MVPControl", "MVPConf0", "MVPConf1" },
			...
			new String[] { "BadVaddr", "BadInstr", "BadInstrP", }, new String[] { "Count" },
			new String[] { "EntryHi", null, null, null, "GuestCtl1", "GuestCtl2", "GuestCtl3" }, new String[] { "Compare", null, null, null, "GuestCtl0Ext" },
			
			new String[] { "Status", "IntCtl", "SRSCtl", "SRSMap", "View_IPL", "SRSMap2", "GuestCtl0", "GTOffset" },
			new String[] { "Cause", null, null, null, "View_RIPL", "NestedExc", }, new String[] { "EPC", null, "NestedEPC" },
	 ...
	 */
	public static String isnString (Cpu cpu) {
	...
	public static int base (int isn) {
		return rs(isn);
	}
	
	public static int rs (int isn) {
		return (isn >>> 21) & 0x1f;
	}
	
	public static int rt (int isn) {
		return (isn >>> 16) & 0x1f;
	}
	
	public static int rd (int isn) {
		return (isn >>> 11) & 0x1f;
	}
	
	public static int sa (int isn) {
		return (isn >>> 6) & 0x1f;
	}
	
	public static int fn (int isn) {
		return isn & 0x3f;
	}
	
	/** same as rd */
	public static int fs (int isn) {
		return rd(isn);
	}
	
	/** same as rt */
	public static int ft (int isn) {
		return rt(isn);
	}
	
	/** same as sa */
	public static int fd (int isn) {
		return sa(isn);
	}
	
	public static int sel (int isn) {
		return isn & 0x7;
	}
	
	public static int op (int isn) {
		return isn >>> 26;
	}
	
	/** unsigned immediate */
	public static final int imm (int isn) {
		return isn & 0xffff;
	}
	
	/** sign extended immediate */
	public static final int simm (int isn) {
		return (short) isn;
	}
	
	/** syscall or break number */
	public static final int syscall (int isn) {
		return (isn >>> 6) & 0xfffff;
	}
	
	/** jump target */
	public static final int jump (int isn, int pc) {
		return (pc & 0xf0000000) | ((isn & 0x3FFFFFF) << 2);
	}
	
	private static String formatIsn (Isn name, int isn, Cpu cpu) {
	...
	public static int branch (int isn, int pc) {
	...
	public static boolean fpTrue (int isn) {
		// see BC1F
		return (isn & 0x10000) != 0;
	}
	
	private static String fpFormatName (int rs) {
		switch (rs) {
			case FP_RS_D:
				return "d";
			case FP_RS_S:
	...
	private static String cpRegName (int rd, int sel) {
		...
		if (rd < CP_REG_NAMES.length) {
			String[] rdnames = CP_REG_NAMES[rd];
	...
	public static String gpRegString (Cpu cpu) {
		final int pc = cpu.getPc();
		final int[] reg = cpu.getRegisters();
		final Symbols syms = cpu.getSymbols();
	...
	public static void setSingle(int[] fpReg, int i, float f) {
	...
	public static void setDouble(int[] fpReg, int i, double d) {
